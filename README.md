...
- Enter Reflections: Replace the `_enter_` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
1. Separting functions and reducing their complexity
2. modularity with the understanding of domail
3. improving junit quality to improve testing
